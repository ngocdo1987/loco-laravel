...
static welcome: Dir<'_> = include_dir!("src/modules/auth/mailer/welcome");
static forgot: Dir<'_> = include_dir!("src/modules/auth/mailer/forgot");
static magic_link: Dir<'_> = include_dir!("src/modules/auth/mailer/magic_link");
